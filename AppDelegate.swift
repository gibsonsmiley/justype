...
//        AppearanceController.initializeAppearance()
    ...
    func applicationDidBecomeActive(application: UIApplication) {
        ...
        // Always reopen the writer view when the app is closed, regardless of what view was seen before closing. This instantiates a new writer view which is always empty, preventing users from continuing on the note they may have left.
